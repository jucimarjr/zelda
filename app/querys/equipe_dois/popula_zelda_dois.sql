...
/* Insere um processo no sistema  */
INSERT INTO `processo_dois` (`processo_id`, `processo_descricao`, `processo_tipo`, `processo_status`, `usuario_id`) VALUES (NULL, 'Solicitação de Reaproveitamento de Disciplina', 'Essencial', '1', '1');

/* Insere um documento no sistema  */
INSERT INTO `documento_dois` (`documento_id`, `documento_descricao`, `documento_tipo`, `documento_status`, `processo_id`) VALUES (NULL, 'Solicitaçãod de Reaproveitamento de Disciplina', 'Boletim', '1', '1');
