...
--
-- Tabela de processo equipe 3
--

DROP TABLE IF EXISTS Processo;
CREATE TABLE  Processo(
  processo_id int(11) AUTO_INCREMENT NOT NULL,
  processo_nome_aluno varchar(50) NOT NULL,
  processo_tipo varchar(20) NOT NULL,
  processo_descricao varchar(200) NOT NULL,
  processo_link varchar(200) NOT NULL,
